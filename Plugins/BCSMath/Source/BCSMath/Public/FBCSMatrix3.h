...
public:
	...
	FBCSMatrix3(float m11, float m12, float m21, float m22, float m31, float m32, float m33)
	{
	...
	{
		_11 += M.11; _12 += M.12; _13 += M.13;	
		_21 += M.21; _22 += M.22; _23 += M.23;		
		_31 += M.31; _32 += M.32; _33 += M.33;
