...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBCSMathTest, "Game.BCSMath", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)

// 창 -> 개발자툴 -> 세션 프론트앤드 -> 자동화
bool FBCSMathTest::RunTest( const FString& Parameters )
{
	FVector fv1 = FVector(1.0f, 1.0f, 1.0f);
	FVector fv2 = FVector(2.0f, 3.0f, 4.0f);
	FVector fv3 = FVector(3.0f, 4.0f, 5.0f);
	TestEqual(TEXT("FVector Add Test"), fv1 + fv2, fv3);

	
	FBCSVector3 v1 = FBCSVector3(1.0f, 1.0f, 1.0f);
	FBCSVector3 v2 = FBCSVector3(2.0f, 7.0f, 4.0f);
	FBCSVector3 v3 = FBCSVector3(3.0f, 4.0f, 5.0f);
	TestEqual(TEXT("FBCSVector3 Add Test"), v1 + v2, v3);
